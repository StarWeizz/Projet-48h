...
function rendreQuestionCourante() {
	...
	btnValider.textContent = "Valider ma réponse";
...
function verifierReponses() {
	...
	mettreAJourTopbar();
	elAccroche.textContent = `Résultat manche : ${nbBonnes}/${manche.questions.length} bonnes réponses (+${pointsGagnes} pts).`;
}
...
function afficherResumeFinal() {
	...
	elImageLabel.textContent = "Partie terminée";
	elImageScene.innerHTML = "";
	elImageScene.setAttribute("aria-label", "Résumé final du mini-jeu");
